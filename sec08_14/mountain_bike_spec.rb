...
describe MountainBike do
  context 'for rigid mountain bike' do
    let(:bike) { MountainBike.new(RigidMountainBike.new(
  ...
  context 'for front suspension bike' do
    let(:bike) { MountainBike.new(FrontSuspensionMountainBike.new(
  ...
  context 'for full mountain bike' do
    let(:bike) { MountainBike.new(FullSuspensionMountainBike.new(
